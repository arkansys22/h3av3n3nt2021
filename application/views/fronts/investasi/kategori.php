        ...
        <div class="row">
          <div class="col-xs-12 col-sm-4 col-md-3">
            ...
            <div class="sidebar-block">
              ...
              <ul class="sidebar-category color-1">
                ...
                <li class=""><?php $jmlaa = $this->model_app->view('blogs_tbl')->num_rows(); ?>
          ...
          <div class="col-xs-12 col-sm-8 col-md-9">
            <div class="grid-content clearfix">
              <?php
                    foreach ($post_news->result_array() as $post_new) {
                    ...
                    <div class="table-view">
                        ...
                        <div class="title hotel-middle clearfix cell-view">
                          <div class="date list-hidden"><strong><?php echo $post_new[nama_kategori]?></strong></div>
                            <h4><b><?php echo $post_new[nama]?></b></h4>
                                 <div class="rate-wrap">
                                    <i><?php echo $post_new[lokasi]?></i>
                                  </div>
                        </div>
                        <div class="title hotel-right clearfix cell-view">
                            <a href="<?php echo base_url("investasi/$post_new[judul_seo]") ?>" class="c-button bg-dr-blue hv-dr-blue-o b-50 fl">Lihat Lengkapnya</a>
                        </div>
                      </div>
                  </div>
              </div>
