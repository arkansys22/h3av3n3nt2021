                            ...
                            <div class="collapse navbar-collapse" id="myNavbar">
                                <ul class="nav navbar-nav js-menubar">
                                    ...
                                    <li class="level1 active dropdown"><a href="#">Gallery</a>
                                        <span class="plus js-plus-icon"></span>
                                        <ul class="dropdown-menu menu-level-1 ">
                                            <li class="level2"><a href="<?php echo base_url () ?>gallery-foto" title="Homepage">Photo</a></li>
                                            <li class="level2"><a href="<?php echo base_url () ?>gallery-video" title="Homepage">Video</a></li>
                                        </ul>
                                    </li>
                                    </li>
                                    <li class="level1 dropdown"><a href="<?php echo base_url () ?>blogs">Blogs</a></li>
                                    <li class="level1 dropdown"><a href="<?php echo base_url () ?>kontak">Contact</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
