		...
		<div class="container">
				<div class="post-content text-center">
					 <div class="heading-content">
							 <p><?php echo tgl_indo($post->tanggal)?> <?php echo $post->jam?>
							 <h3><?php echo $post->judul?></h3></p>
							 <div class="post-element v3">
										<div class="post-date">by : <?php echo $post->username?></div>
										<div class="post-date post-author"><?php echo $post->views?> views</div>
										<div class="post-date post-author"><i class="fa fa-share-alt"></i></div>
								</div>
					 </div>
					 <div class="single-post-content">
							 <a href="#" class="hover-images"><img src="<?php echo base_url()?>asset/foto_private/<?php echo $post->gambar?>" alt="" class="img-responsive"></a>
						...
						<div class="owl-carousel owl-theme js-owl-blog">
							<?php
							 ...
							 ?>
								...
								<div class="blog-item">
										<div class="post-img"><a class="hover-images"><img src="<?php echo base_url()?>asset/foto_private/<?php echo $post_new->gambar?>" alt="" class="img-responsive"></a></div>
