          ...
          <div class="col-xs-12 col-sm-4 col-md-3">
            ...
            <div class="sidebar-block">
              ...
              <ul class="sidebar-category color-1">
                ...
                <li><?php $jmlai = $this->model_app->view('investasi_tbl')->num_rows(); ?>
                  ...
                  <div class="hotel-item style-3 bg-white">
                    <div class="table-view">
                        ...
                        <div class="title hotel-right clearfix cell-view">
                            <a href="<?php echo base_url("vendor/$post_new->judul_seo ") ?>" class="c-button bg-dr-blue hv-dr-blue-o b-50 fl">Lihat Lengkapnya</a>
                        </div>
                      </div>
                  </div>
              </div>
