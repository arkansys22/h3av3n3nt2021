    ...
    <div class="detail-wrapper">
    	<div class="container">
    		<div class="detail-header">
                ...
                <div class="share clearfix">
                  ...
                  <li class="color-ig"><a href="whatsapp://send?text=<?php echo $post_news->judul ?> - ANT Tour| <?php echo base_url("paket/$post_news->judul_seo ") ?>"><i class="fa fa-whatsapp"></i>WhatsApp</a></li>
                </div></div>
    	       	</div>
       </div>
      <div class="row padd-90">
                  ...
                  <div class="embed-responsive embed-responsive-16by9">
  									<img class="img-full img-responsive" src="<?php echo base_url()?>asset/foto_private/<?=$post_news->gambar2?>" alt="">
  								</div>
    	          ...
    	          <div class="accordion style-6">
                    ...
                    <div class="acc-panel">
                        ...
                        <p><strong>IDR <?php echo number_format($post_news->harga_min)?></strong> /pax</p>
    							<p>Private List</p>
    							<?php echo $post_news->kapasitas_min?>
    							</div>
    	              </div>
                    <div class="acc-panel">
                              ...
                              <div class="col-xs-12 col-md-8">
                                <?php echo $post_news->partisipan?>
                      			  ...
                      			  <div class="buttons-wrap">
                      				  <a href="https://api.whatsapp.com/send?phone=6281291888852&text=Hai%20Ant%20Tour%20!%20Kami%20mau%20ikut%20<?php echo $post_news->nama?>" class="c-button m-right bg-7">Booked This Trip</a>
                      			  </div>
                       </div>
    	              </div>
                    <div class="acc-panel">
    	                 ...
    	                 <div class="acc-body">
    					    <p>Khusus Syarat & Kententuan Paket Wisata Private Trip Akan Dikirimkan Via Email.</p>
    					</div>
    	              </div>
                  ...
                  <li class="color-ig"><a href="whatsapp://send?text=<?php echo $post_news->judul ?> - ANT Tour| <?php echo base_url("paket/$post_news->judul_seo ") ?>"><i class="fa fa-whatsapp"></i>WhatsApp</a></li> 
                   ...
                   <div  class="fb-comments" data-href="<?php echo base_url("paket/$post_news->judul_seo")?>" data-numposts="15"></div>
    				    </div>
           		</div>
      <div class="col-xs-12 col-md-4">
           			<div class="right-sidebar">
    					<div class="popular-tours bg-grey-2">
    						<h4 class="color-dark-2">LIKE US</h4>
                            <div class="hotel-small style-2 clearfix">
                              <div class="fb-page" data-href="https://www.facebook.com/anttourID/" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/anttourID/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/anttourID/">ANT Tour Indonesia</a></blockquote></div>
                            </div>
                        </div>
              <div class="popular-tours bg-grey-2">
                <h4 class="color-dark-2">Other Private Trip</h4>
                 <?php
