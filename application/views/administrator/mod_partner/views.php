            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-primary btn-sm' href='<?php echo base_url(); ?>administrator/tambah_list_partner'>Tambah Testimoni</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php
                    ...
                    echo "<tr><td>$no</td>
                              <td>
                              <a target='_BLANK' href='".base_url()."blog/$row[judul_seo]'>$row[judul]</a>
                              </td>
                              <td><center>
