...
.tt-suggestion p {
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-warning alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          Halo <?php echo "$usr[nama_lengkap]"; ?> !
  ...
  <script src="<?php echo base_url()?>asset/frontend/aspanel/js/price.js"></script>
  <script type="text/javascript">
  $(document).ready(function(){
        $('#harga_min').maskMoney({prefix:'', thousands:'.', decimal:',', precision:0});
        $('#harga_max').maskMoney({prefix:'', thousands:'.', decimal:',', precision:0});
      });
  </script>
