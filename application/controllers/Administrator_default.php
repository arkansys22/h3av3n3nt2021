...
// Controller Menu 1
	function list_ot(){
		cek_session_akses('list_ot',$this->session->id_session);
        if ($this->session->level=='admin'){
	    ...
	    $data['judul']   = 'Open Trip';
		$this->template->load('administrator/template','administrator/mod_opentrip/view_berita',$data);
	}
	function tambah_list_ot(){
		cek_session_akses('list_ot',$this->session->id_session);
		if (isset($_POST['submit'])){
          ...
          $config['source_image'] = 'asset/foto_open/'.$img2['file_name'];
			...
			redirect('administrator/list_ot');
		}else{

            $data['tag'] = $this->model_app->view_ordering('tag','id_tag','DESC');
            $data['record'] = $this->model_app->view_ordering('kategori','id_kategori','DESC');
			$this->template->load('administrator/template','administrator/mod_opentrip/view_berita_tambah',$data);
		}
	}
	function edit_list_ot(){
		cek_session_akses('list_ot',$this->session->id_session);
		...
		if (isset($_POST['submit'])){
          ...
          $config['source_image'] = 'asset/foto_open/'.$img2['file_name'];
			...
			$this->template->load('administrator/template','administrator/mod_opentrip/view_berita_edit',$data);
		}
	}
	function delete_list_ot(){
        cek_session_akses('list_ot',$this->session->id_session);
        if ($this->session->level=='admin'){
	...
	function listgaleri(){
		...
		function listvideo(){
		cek_session_akses('listvideo',$this->session->id_session);
				if ($this->session->level=='admin'){
	...
	function edit_listpromo(){
		...
		if (isset($_POST['submit'])){
			...
			$tag = $this->model_app->view_ordering('tag','id_tag','DESC');
						$record = $this->model_app->view_ordering('kategori_undangan','id_kategori','DESC');
						if ($this->session->level=='admin'){
	...
	function tambah_listgaleri(){
		...
		if (isset($_POST['submit'])){
	        ...
	        $this->upload->do_upload('k');
	        $hasil=$this->upload->data();
            $config['source_image'] = 'asset/foto_galeri/'.$hasil['file_name'];
            ...
            $data['tag'] = $this->model_app->view_ordering('tag','id_tag','DESC');
            $data['record'] = $this->model_app->view_ordering('kategori_undangan','id_kategori','DESC');
	...
	function kategori_pt(){
        ...
        $data['judul']   = 'Kategori Private Trip';
    ...
    function promo(){
        ...
        if ($this->session->level=='admin'){
              $data['record'] = $this->model_app->view_ordering('promo_tbl','id','DESC');
        }else{
            $data['record'] = $this->model_app->view_join_where('promo_tbl',array('promo_tbl.username'=>$this->session->username),'id','DESC');
        }
        $this->template->load('administrator/template','administrator/mod_promo/view_promo',$data);
    }

    function tambah_promo(){
        cek_session_akses('promo_tbl',$this->session->id_session);
        if (isset($_POST['submit'])){
            ...
            $this->template->load('administrator/template','administrator/mod_promo/view_video_tambah',$data);
        }
    }
    ...
    function edit_video(){
        ...
        if (isset($_POST['submit'])){
            ...
            $this->template->load('administrator/template','administrator/mod_promo/view_video_edit',$data);
        }
    }
